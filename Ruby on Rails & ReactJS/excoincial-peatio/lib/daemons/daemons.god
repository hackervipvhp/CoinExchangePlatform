...
daemon 'amqp:deposit_fiat',
       script:   'amqp_daemon.rb',
       arguments: %w[ deposit_fiat ]
...
daemon 'amqp:withdraw_escrow',
       script:   'amqp_daemon.rb',
       arguments: %w[ withdraw_escrow ]


daemon 'blockchain:btc-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ btc-mainnet ]

daemon 'blockchain:eth-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ eth-mainnet ]

daemon 'blockchain:btx-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ btx-mainnet ]

daemon 'blockchain:reex-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ reex-mainnet ]

daemon 'blockchain:reex-hot-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ reex-hot-mainnet ]

daemon 'blockchain:mnpro-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ mnpro-mainnet ]

daemon 'blockchain:mnpro-hot-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ mnpro-hot-mainnet ]

daemon 'blockchain:xrp-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ xrp-mainnet ]

daemon 'blockchain:ltc-mainnet',
       script: 'blockchain.rb',
       arguments: %w[ ltc-mainnet ]

Dir.glob "#{File.dirname(__FILE__)}/**/*.rb" do |file|
  script = File.basename(file)
  next if %w[ amqp_daemon.rb blockchain.rb liquidity.rb bot.rb ].include?(script)
