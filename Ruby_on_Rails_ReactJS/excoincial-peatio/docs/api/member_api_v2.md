...
**Contact information:**  
Oleksandr Papevis CTO of Excoincial Exchange, Head of Support Africunia Bank  
https://excoincial.com  
aleksander@africunia.org  

**License:** https://github.com/africunia/excoincial-api/blob/master/LICENSE.md
...
| ---- | ---------- | ----------- | -------- | ---- |
| symbol | query | Symbol Name | Yes | string |
| resolution | query | resolution | Yes | string |
| from | query | Symbol Name | Yes | integer |
| to | query | Symbol Name | Yes | integer |

##### Responses

| Code | Description |
| ---- | ----------- |
| 200 | Returns history bars |
...
| Code | Description |
| ---- | ----------- |
| 200 | Returns system time |

### /v2/tradingview/symbols
...
### /v2/tradingview/config

#### GET
##### Description:

Returns TradingView Config

##### Responses

| Code | Description |
| ---- | ----------- |
| 200 | Returns TradingView Config |
...
| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| currency | query | Currency value contains afcash,boltt,btc,btx,cbc,ceth,eta,eth,gmc,hot,kit,ltc,ntc,reex,tusd,usd,xlmgold,xrp,ytc,AFCASH,BOLTT,BTC,BTX,CBC,CETH,ETA,ETH,GMC,HOT,KIT,LTC,NTC,REEX,TUSD,USD,XLMGOLD,XRP,YTC | No | string |
...
| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| currency | query | Any supported currencies: afcash,boltt,btc,btx,cbc,ceth,eta,eth,gmc,hot,kit,ltc,ntc,reex,tusd,usd,xlmgold,xrp,ytc,AFCASH,BOLTT,BTC,BTX,CBC,CETH,ETA,ETH,GMC,HOT,KIT,LTC,NTC,REEX,TUSD,USD,XLMGOLD,XRP,YTC. | No | string |
