...
ActiveRecord::Schema.define(version: 20190912132009) do
  ...
  create_table "bank_details", force: :cascade do |t|
    ...
    t.string   "bank_branch_code", limit: 255
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.datetime "created_at",                                null: false
    t.datetime "updated_at",                                null: false
    t.integer  "ref_member_id", limit: 4
    t.boolean  "zero_fee",                  default: false, null: false
  ...
  add_index "members", ["house_fee"], name: "index_members_on_house_fee", using: :btree
  add_index "members", ["ref_member_id"], name: "index_members_on_ref_member_id", using: :btree
  add_index "members", ["sn"], name: "index_members_on_sn", unique: true, using: :btree
  add_index "members", ["zero_fee"], name: "index_members_on_zero_fee", using: :btree
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                          null: false
    t.datetime "updated_at",                                                          null: false
    t.boolean  "stop_loss",                                           default: false
  end
  ...
  add_index "rewards", ["member_id"], name: "index_rewards_on_member_id", using: :btree
  add_index "rewards", ["ref_member_id"], name: "index_rewards_on_ref_member_id", using: :btree
