...
class Currency < ActiveRecord::Base
  ...
  DEFAULT_OPTIONS_SCHEMA = {
    ...
    price: {
        title: 'USD Price For Coin or Fiat',
        type: 'number'
    },
    upstream_downscale: {
      title: 'Apply factor to mirrored upstream volume',
      type: 'number'
    }
  }
  OPTIONS_ATTRIBUTES = %i[erc20_contract_address gas_limit gas_price price upstream_downscale].freeze
